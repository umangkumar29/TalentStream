...
class OpenAIService:
    ...
    def generate_jd_from_keywords(self, keywords: str, role_title: str) -> str:
        ...
        system_prompt = (
            ...
            "IMPORTANT:\n"
            "- Do NOT use markdown formatting (no **, ###, ---, or bullet symbols like *, -)\n"
            "- Do NOT use any special characters for styling\n"
            "- Return plain clean text only\n"
            "- Use simple paragraphs and headings in normal text\n"
            "- Keep formatting suitable for directly displaying in a textarea field\n\n"
            "Structure:\n"
            "Job Title\n"
            "Role Overview\n"
